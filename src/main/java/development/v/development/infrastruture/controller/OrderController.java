...
@Tag(name = "Pedido", description = "Administra los pedidos")
@RestController
...
public class OrderController {
    ...
    @Operation(summary = "Obtiene una lista paginada de pedidos", description = "Permite obtener una lista de pedidos con paginación y filtros opcionales")
    @GetMapping
    ...
    @Operation(summary = "Obtiene un pedido por su ID", description = "Permite obtener los detalles de un pedido específico utilizando su ID")
    @GetMapping("/{id}")
    public ResponseEntity<DataResultDto<Order>> getById(@PathVariable Long id) {
    ...
    @Operation(summary = "Elimina un pedido por su ID", description = "Permite eliminar un pedido específico utilizando su ID")
    @DeleteMapping("/{id}")
    public ResponseEntity<DataResultDto<Order>> delete(@PathVariable Long id) {
