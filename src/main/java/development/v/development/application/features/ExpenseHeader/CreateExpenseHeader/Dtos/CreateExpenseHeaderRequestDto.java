package development.v.development.application.features.ExpenseHeader.CreateExpenseHeader.Dtos;
...
@Schema(description = "Request para crear un encabezado de egreso")
public class CreateExpenseHeaderRequestDto {
    ...
    @Schema(description = "Numero de egreso unico", example = "1001")
