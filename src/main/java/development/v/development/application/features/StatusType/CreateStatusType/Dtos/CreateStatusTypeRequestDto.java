package development.v.development.application.features.StatusType.CreateStatusType.Dtos;
...
@Schema(description = "Request para crear un tipo de estado")
public class CreateStatusTypeRequestDto {
