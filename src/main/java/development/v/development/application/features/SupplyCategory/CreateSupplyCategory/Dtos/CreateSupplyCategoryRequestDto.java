package development.v.development.application.features.SupplyCategory.CreateSupplyCategory.Dtos;
...
@Schema(description = "Request para crear una categoria de insumo")
public class CreateSupplyCategoryRequestDto {
