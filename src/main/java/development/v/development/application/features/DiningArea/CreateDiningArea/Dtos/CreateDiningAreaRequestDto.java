package development.v.development.application.features.DiningArea.CreateDiningArea.Dtos;
...
@Schema(description = "Request para crear un area de mesa")
public class CreateDiningAreaRequestDto {
