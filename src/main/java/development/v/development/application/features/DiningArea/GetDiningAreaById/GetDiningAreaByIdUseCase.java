package development.v.development.application.features.DiningArea.GetDiningAreaById;
...
@Service
public class GetDiningAreaByIdUseCase {

    private final DiningAreaRepository repository;

    public GetDiningAreaByIdUseCase(DiningAreaRepository repository) {
