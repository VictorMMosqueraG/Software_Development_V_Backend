...
public class UpdateCashReceiptMapper {
    ...
    public static CashReceipt toDomain(Long id, UpdateCashReceiptRequest request) {
        CashReceipt cashReceipt = new CashReceipt();
        cashReceipt.setRcNum(id);
        cashReceipt.setSedeId(request.getSedeId());
        ...
        cashReceipt.setFpId(request.getFpId());
        cashReceipt.setRcSubtotal(request.getRcSubtotal());
        cashReceipt.setRcDescuento(request.getRcDescuento());
        cashReceipt.setRcPropina(request.getRcPropina());
        cashReceipt.setRcTotal(request.getRcTotal());
        cashReceipt.setRcMontoRec(request.getRcMontoRec());
        cashReceipt.setRcCambio(request.getRcCambio());
