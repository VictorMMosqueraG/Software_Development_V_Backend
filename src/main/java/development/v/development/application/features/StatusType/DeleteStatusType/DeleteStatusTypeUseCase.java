package development.v.development.application.features.StatusType.DeleteStatusType;
...
@Service
public class DeleteStatusTypeUseCase {

    private final StatusTypeRepository repository;

    public DeleteStatusTypeUseCase(StatusTypeRepository repository) {
