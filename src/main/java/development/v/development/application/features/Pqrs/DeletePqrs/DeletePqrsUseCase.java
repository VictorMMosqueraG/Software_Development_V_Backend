package development.v.development.application.features.Pqrs.DeletePqrs;
...
@Service
public class DeletePqrsUseCase {
    private final PqrsRepository repository;

    public DeletePqrsUseCase(PqrsRepository repository) {
