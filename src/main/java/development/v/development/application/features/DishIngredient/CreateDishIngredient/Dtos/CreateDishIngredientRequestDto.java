package development.v.development.application.features.DishIngredient.CreateDishIngredient.Dtos;
...
@Schema(description = "Request para crear un ingrediente de plato")
public class CreateDishIngredientRequestDto {
