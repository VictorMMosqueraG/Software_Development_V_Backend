package development.v.development.application.features.PqrsType.CreatePqrsType.Dtos;
...
@Schema(description = "Request para crear un tipo de PQRS")
public class CreatePqrsTypeRequestDto {
