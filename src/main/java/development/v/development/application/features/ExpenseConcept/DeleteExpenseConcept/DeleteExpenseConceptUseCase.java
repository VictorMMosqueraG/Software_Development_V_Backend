package development.v.development.application.features.ExpenseConcept.DeleteExpenseConcept;
...
@Service
public class DeleteExpenseConceptUseCase {
    private final ExpenseConceptRepository repository;

    public DeleteExpenseConceptUseCase(ExpenseConceptRepository repository) {
