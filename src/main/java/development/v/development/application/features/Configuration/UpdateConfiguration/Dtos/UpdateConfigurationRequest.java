package development.v.development.application.features.Configuration.UpdateConfiguration.Dtos;
...
public class UpdateConfigurationRequest {
    ...
    @Schema(description = "Clave de configuracion", example = "NOMBRE_EMPRESA")
